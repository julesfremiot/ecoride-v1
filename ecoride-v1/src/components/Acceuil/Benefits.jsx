    ...
    return (
        <div className="flex flex-col items-center justify-center mt-10">
            <div className="text-center p-4 first-section">
                ...
                <div className="h-20 w-20 rounded-full benefits-pin-1 inline-block mr-2 shadow-md flex-none"></div>
            ...
            <div className="text-center p-4 first-section">
                ...
                <div className="h-20 w-20 rounded-full benefits-pin-2 inline-block ml-4 shadow-md flex-none"></div>
                </div>
            ...
            <div className="text-center p-4 first-section">
                <div className="flex items-center">
                <div className="h-20 w-20 rounded-full benefits-pin-3 inline-block ml-4 shadow-md flex-none"></div>
