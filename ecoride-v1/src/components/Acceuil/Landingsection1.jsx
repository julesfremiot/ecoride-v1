...
export default function landingSection(){
    return (
        <>
            ...
            <h1 className="text-white font-bold text-5xl text-center mt-7">Trouve ton Ecoride!</h1>
            <h2 className="font-medium text-white text-lg text-center mt-4 mb-2">Inscrit-toi et débloque<br></br> 1000+ trajets éco-friendly tout les jours.</h2>
            </div>
        </>
    )
}