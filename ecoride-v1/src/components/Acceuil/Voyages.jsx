...
export default function Voyages(){
    ...
    return (
        <>
            <div className="w-screen pt-10 bg-green-950 z-0 flex flex-col gap-4 items-center pb-8 rounded-b-2xl shadow-md">
                ...
                <div className="bg-white flex rounded w-10/12 py-4 shadow-md mt-6">
                    ...
                    <div className="flex flex-col justify-between items-start ml-10 w-20">
                        ...
                        <p className="hover:translate-x-2 transform transition duration-300 ease-in-out text-2xl leading-none font-bold text-green-500 h-6 hover:text-green-700">8€<i className="bi bi-arrow-right text-xl ml-4"></i></p>
                    </div>
                </div>
                <div className="bg-white flex rounded w-10/12 py-4 shadow-md mt-6">
                    <div className="flex pl-4">
                    ...
                    <div className="flex flex-col justify-between items-start ml-10 w-20">
                        <p className="leading-none text-gray-500">À partir de:</p>
                        <p className="hover:translate-x-2 transform transition duration-300 ease-in-out text-2xl leading-none font-bold text-green-500 h-6 hover:text-green-700">12€<i className="bi bi-arrow-right text-xl ml-4"></i></p>
                    </div>
                </div>
                <div className="bg-white flex rounded w-10/12 py-4 shadow-md mt-6">
                    <div className="flex pl-4">
                    ...
                    <div className="flex flex-col justify-between items-start ml-10 w-20">
                        <p className="leading-none text-gray-500">À partir de:</p>
                        <p className="hover:translate-x-2 transform transition duration-300 ease-in-out text-2xl leading-none font-bold text-green-500 h-6 hover:text-green-700">16€<i className="bi bi-arrow-right text-xl ml-4"></i></p>
                    </div>
                </div>
                <div className="bg-white flex rounded w-10/12 py-4 shadow-md mt-6">
                    <div className="flex pl-4">
                    ...
                    <div className="flex flex-col justify-between items-start ml-10 w-20">
                        <p className="leading-none text-gray-500">À partir de:</p>
                        <p className="hover:translate-x-2 transform transition duration-300 ease-in-out text-2xl leading-none font-bold text-green-500 h-6 hover:text-green-700">10€<i className="bi bi-arrow-right text-xl ml-4"></i></p>
                    </div>
                </div>
